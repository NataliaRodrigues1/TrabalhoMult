...
```{r, histogramas, echo=FALSE, fig.width=15, fig.height=15, fig.cap="BoxPlots", include=FALSE}
...
mycolors <- c("red", "blue")
par(mfrow=c(1,3))
plot(cp2,cp1, col=mycolors[factor(Especie)], cex=1.2,ylim=c(-6,6),xlim=c(-5,5), pch=16)

plot(cp1,cp3, col=mycolors[factor(Especie)], cex=1.2,ylim=c(-3,3),xlim=c(-5,5), pch=16)

plot(cp2,cp3, col=mycolors[factor(Especie)], cex=1.2,ylim=c(-3,3),xlim=c(-4,6), pch=16)
